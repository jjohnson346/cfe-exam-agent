...
/**
 * MLPassage3 uses a bag of words/bayesian algorithm to determine the relative likelihood of each option given the
 ...
 * 
 * This algorithm is an enhancement to MLPassage2 in that it stems the words before doing the frequency counts.
 * 
 * 
 */
public class MLPassage2 implements IAlgorithm {

	private final String INPUT_FILE = "ml.test.7.txt";

	@Override
	public int solve(CFEExamQuestion question, CFEManual cfeManual) {
		System.out.println("executing MLPassage2 algorithm for " + question.name + "...");
		try {
			...
			System.out.println(passages.get(0));
			//
